...
async function addAllUsers(cursor = null) {
  try {
    const apiUrl = cursor
      ? `https://api.neynar.com/v2/farcaster/feed/channels?channel_ids=sfoxzo&with_recasts=true&with_replies=true&limit=100&cursor=${cursor}`
      : 'https://api.neynar.com/v2/farcaster/feed/channels?channel_ids=sfoxzo&with_recasts=true&with_replies=true&limit=100';
